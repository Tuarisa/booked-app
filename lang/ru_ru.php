...
class ru_ru extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['AddBlackout'] = 'Добавить техобслуживание';
		$strings['AllResourcesOn'] = 'All Resources On';
		$strings['Reason'] = 'Reason';
		$strings['BlackoutShowMe'] = 'Показать техобслуживания';
		$strings['BlackoutDeleteConflicts'] = 'Удалить техобслуживание';
		$strings['Filter'] = 'Найти';
		$strings['Between'] = 'Между';
		$strings['CreatedBy'] = 'Создано';
		$strings['BlackoutCreated'] = 'Техобслуживание создано';
		$strings['BlackoutNotCreated'] = 'Техобслуживание не может быть создано';
		$strings['BlackoutUpdated'] = 'Обновлено';
		$strings['BlackoutNotUpdated'] = 'Не может быть обновлено';
		$strings['BlackoutConflicts'] = 'Обнаружен конфликт';
		$strings['ReservationConflicts'] = 'Конфликт при создании времени заказа';
		...
		$strings['ManageBlackouts'] = 'Добавить авто в ремонт';
